...
「これは気になる」
「続きが読みたい」
と思って、記事を開きたくなるフックを作ってください。

ニュースを要約するのではなく、
「記事を読みたくなる入口」を作ることが目的です。
...
記事の結論をフックだけで全部説明しないでください。

具体的な事実や意外な変化を見せたあと、
「その先が気になる」と思うところで止めてください。

読者がフックを読んだだけで、
記事の答えが分かってしまう文章は禁止です。
...
悪い例：
人為的汚染37％減でも山火事煙が2倍増、その影響は胎児にまで及ぶでやんす

良い例：
人為的汚染37％減でも山火事煙が2倍増、胎児への影響は…でやんす

良い例：
人為的汚染37％減でも山火事煙が2倍増、その背景とは…でやんす

良い例：
貧困率が29.4％→6.2％に？人口8500人の町で起きた変化とは…でやんす

良い例：
270億パラメーターAIが無料公開？その性能と仕組みが気になるでやんす
...
「やんす」「でやんす」は自然な場合だけ1回使用してください。

無理に「やんす」を入れて不自然になる場合は、
自然な日本語を優先してください。
