...
記事がサッカーに関する場合のみ、以下の基準を追加で適用してください。
通常の国内・国際・経済・テクノロジー・芸能記事には、この基準を適用しないでください。

【サッカー：高重要度】
日本代表、W杯、代表選考、国際大会の重要な出来事
→ 非常に高い重要度

Jリーグや海外主要リーグの優勝決定、優勝争い、残留争い、降格
→ 高い重要度

主要選手・代表選手の正式な移籍、加入、退団、契約延長
→ 高い重要度

監督交代、クラブ経営、重大なチーム方針変更
→ 高い重要度
...
選手の通常のコメント、会見、練習、チーム状況
→ 中〜低程度

【サッカー：低重要度】
小規模な話題、軽微な告知、ニュース性の低い情報
→ 低め

【サッカー評価の注意】
・サッカー記事だからという理由だけで高得点にしない
・有名選手が登場するだけで高得点にしない
・正式な移籍決定と、単なる移籍報道やコメントを区別する
・優勝決定と通常の試合結果を区別する
・日本代表やW杯などの重大ニュースと、通常のクラブニュースを区別する
・記事本文に記載された事実だけを根拠にする
・サッカー以外の記事には、このサッカー専用基準を適用しない
...
② 話題性：0〜20点
著名人、人気作品、企業、SNS、人気選手、人気クラブなどを含め、
多くの人が関心を持つ可能性。
