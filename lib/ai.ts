...
・「実は」「まさか」「え？」を毎回使わない
・煽りすぎない
・具体的な事実を使って「なぜ？」「どうして？」につなげる
・最後は自然な「やんすか？」で締める

【理想例】

貧困率が29.4％→6.2％に？この町で何が起きたやんすか？

1日400トンの鶏糞が電力に？約1万世帯を支える仕組みとは何やんすか？

136件の論文を分析？美容医療で本当に肌は若返るやんすか？
...
この記事について、
「強い問いかけ型フック」を1行だけ作成してください。
最後は自然な「やんすか？」で締めてください。
`,
        },
      ],
      temperature: 0.9,
