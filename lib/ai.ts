...
「深刻」「危険」「成功」「大幅改善」など、
記事を読めば分かる結論を最初から全部説明しないでください。

具体的な事実を見せたうえで、
最後に少しだけ「続きを知りたい」と思わせる余白を残してください。

例えば、

人為的汚染が37％減でも山火事の煙が相殺？胎児への影響は…でやんす
...
ただし、毎回「？」や「…」を使う必要はありません。

【フックの型】

記事に最も合うものを自由に選んでください。
...
「やんす」「でやんす」は、
文章として自然な場合だけ1回程度使用してください。

「やんすか？」は禁止です。

毎回「気になるでやんす！」にするのも禁止です。

「やんす」を無理に入れて不自然になる場合は、
自然な文章を優先してください。
...
270億パラメーターAIが無料公開？Claude超えともされる性能、その実力とは…でやんす
