...
EXAGGERATED JAPANESE BATTLE MANGA
×
VIBRANT AMERICAN COMIC BOOK POSTER
×
DRAMATIC POP ART

さっきの完成イメージに近い、
鮮やかで強烈なアメコミカラーと、
濃密な日本の劇画バトル漫画を融合した表現。
...
画面全体を鮮やかで派手にする。
くすんだ色、淡い色、パステルカラーは禁止。

【キャラクターデザイン】
ニュースの主役と、
その背後に配置する完全オリジナルの人型存在は、
ポージング主体の劇画バトル漫画らしい
非常に濃いキャラクターデザインにする。
...
既存作品のキャラクターをそのまま再現せず、
毎回ニュース内容に合わせて少しずつ異なる
完全オリジナルのキャラクターとして描く。
...
【吹き出し】
画面内にニュースの内容に合った
短い漫画風の吹き出しを1〜2個だけ配置する。

吹き出しは、
キャラクターがニュースを見て自然に発する
短い一言・驚き・感想として表現する。

吹き出しの文章は、
VISUAL PLANに存在する情報だけを利用する。
...
吹き出しの形は、
丸型・ギザギザ型・強調型など、
アメコミや劇画漫画らしい大胆な形状にする。

【独自性】
完成度の高い既存漫画風の雰囲気を持たせながら、
毎回まったく同じキャラクター・衣装・構図にはしない。
