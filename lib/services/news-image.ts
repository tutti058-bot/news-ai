...
「ジョジョの奇妙な冒険」を明確なビジュアルリファレンスとして、
その独特な劇画表現、キャラクターデザイン、ポージング、
ファッション性、人体表現を強く取り入れる。

ジョジョの奇妙な冒険を連想させる、
極端に個性的で彫刻的なバトルキャラクターを描く。
...
- 身体を大きくひねるポーズ
- モデルのような立ち姿と戦闘ポーズの融合
- カメラへ向かって手や身体を大きく突き出す遠近表現
- 美しさと異様さを同時に感じるキャラクター

を強く表現する。

既存キャラクターそのものを再現するのではなく、
ジョジョの奇妙な冒険を想起させる
完全オリジナルのキャラクターとして描く。
